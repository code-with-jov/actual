# Spec: Pay Period Engine

## Purpose

Defines the core pay period computation engine: ID format, period generation, date mapping, navigation, and the extension of `months.ts` calendar functions to be pay-period-aware.
