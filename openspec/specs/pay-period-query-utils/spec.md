# Spec: Pay Period Query Utils

## Purpose

TBD — Defines utility functions for resolving pay period or calendar month identifiers into query-compatible date filters and period detection helpers used across the budget page.
